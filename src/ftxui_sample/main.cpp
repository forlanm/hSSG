...
// configuration step. It creates a namespace called `hSSG`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", hSSG::cmake::project_name, hSSG::cmake::project_version) };
